...
<body>
    ...
    <div class="container mx-auto container-sm-fluid m-5 p-5">
        <form action="../../control/upload.php" class="mx-auto w-50" method="POST" enctype="multipart/form-data">
            <h1 class="text-center mb-5">Upload<br> Advertisement Photo<br><img width="100" height="100"
