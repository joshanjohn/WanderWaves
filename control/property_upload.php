        ...
        if ($fileError == 0) {
            ...
            if ($fileSize < 10000000) { // 10 MB limit
                ...
                if ($_SERVER['SERVER_NAME'] == 'knuth.griffith.ie') {
                    $fileDestination = getRelativePath() . '/Assets/images/property/' . $fileNameNew;

                } else {
                    $fileDestination = '../Assets/images/property/' . $fileNameNew;
                }
                ...
                if (move_uploaded_file($fileTempName, $fileDestination)) {
                    ...
                    $fileDestination = '/Assets/images/property/' . $fileNameNew; // Update file destination for database
